...
`0.2.0` and unpublished, so nothing depends on it by version yet. While the
major is zero the minor acts as the major: pin `>=0.2,<0.3`. The step from
`0.1.0` carried eleven breaks, enumerated in the changelog.
