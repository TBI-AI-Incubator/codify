...
- **Finlex API**: Finlex provides structured HTML with clear section markers. For extraction, the DOM structure is more reliable than PDF OCR. An HTML extraction pathway, rather than the full model pipeline, may be appropriate for Finlex documents.
